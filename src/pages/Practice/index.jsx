...
import { useGetPracticesQuery } from "../../redux/practiceApiSlice";
    ...
    <div>
      {isLoading ? (
        ...
        <section>
          <img
            src={img2}
            className="w-3/4 mx-auto max-w-6xl h-52 mb-3"
            alt=""
          />
          <form className="mt-6">
            <div class="flex">
                    ...
                    >
                      <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex justify-center px-4 pt-4">
                          <Link to={`/course/${practice.practiceId}`}>
                        ...
                        <div class="flex flex-col items-center py-2">
                          ...
                          <div class="flex mt-2 mb-2 space-x-3 md:mt-4">
                            <button
                              ...
                              onClick={() => {
                                navigate(
                                  `/practice/detail/${practice.practiceName}`,
                                  {
                                    state: {
                                      useFor: "practice",
